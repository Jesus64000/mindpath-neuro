...
import { Calendar as CalendarIcon, Clock, Video, MapPin, Star, ChevronRight, ChevronLeft, CheckCircle, XCircle } from 'lucide-react';
...
const DoctorBooking = () => {
    ...
    // Bug #5 Fix: si location.state está vacío (refresh), recuperar el doctor desde la API
    useEffect(() => {
        if (!state?.doctor) {
    ...
    // Generar semana desde lunes con desplazamiento
    ...
    const handleBooking = async () => {
        ...
        try {
            ...
            // Bug #9 Fix: toast en lugar de alert()
        ...
        return (
            <div className="flex items-center justify-center py-24">
                <div className="text-center animate-pulse">
                    <div className="h-24 w-24 bg-mindpath-light rounded-full mx-auto mb-4" />
                    <p className="text-gray-400 font-bold">Cargando perfil del especialista...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="max-w-3xl mx-auto space-y-6 pb-20">
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                ...
                {loadingSlots ? (
                    ...
                    <p className="text-center text-red-400 py-6 font-medium">
                    ...
                    <div className="bg-mindpath-light border border-violet-100 p-4 rounded-2xl mb-4 md:mb-6">
                        ...
                        <div className="flex flex-col gap-2 text-sm text-gray-600">
                            <span className="flex items-center">
                                <Video size={16} className="mr-2 text-mindpath-primary" />
                                {modality === 'virtual' ? 'Online Mind' : 'Presencial'}
                            </span>
                            <span className="flex items-center">
                                <CalendarIcon size={16} className="mr-2 text-mindpath-primary" />
                                {new Date(selectedDate).toLocaleDateString('es-ES')} a las {selectedSlot}
                            </span>
                        </div>
                    </div>
                    <button
